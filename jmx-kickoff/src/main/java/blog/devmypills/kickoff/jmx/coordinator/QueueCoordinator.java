        ...
        try {
            ...
            Thread producerThread = new Thread(
                    ...
                    () -> {
                        ...
                        } catch (ProducerInterruptedException ex) {
                            Thread.currentThread().interrupt();
                            LOGGER.error("Producer thread {}, has been interrupted", Thread.currentThread().getName());
                        } catch (Exception ex) {
                            Thread.currentThread().interrupt();
        ...
        try {
            ...
            Thread consumerThread = new Thread(
                    ...
                    () -> {
                        ...
                        } catch (ConsumerInterruptedException ex) {
                            Thread.currentThread().interrupt();
                            LOGGER.error("Consumer thread {}, has been interrupted", Thread.currentThread().getName());
                        } catch (Exception ex) {
                            Thread.currentThread().interrupt();
